...
<div class="cont">
  ...
  <div class="list">
    <div class="upload">产品：<?php echo ($product["title"]); ?>-<?php echo (get_color_id($color)); if(is_array($attr)): $i = 0; $__LIST__ = $attr;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>-<?php echo ($vo["name"]); endforeach; endif; else: echo "" ;endif; ?>
    </div>
  </div>
  <?php if($product['default_shopid'] == 0): ?><div class="list">
      ...
      <?php else: endif; ?>
  <div class="list">
     <div class="upload">费用<span><?php echo ($product["member_price"]); ?>元</span></div>
  </div>
