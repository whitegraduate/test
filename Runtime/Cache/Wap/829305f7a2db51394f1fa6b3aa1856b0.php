...
<div class="header" >
    ...
    <script src="/wxpay/Public/Wap/js/date/mobiscroll_002.js" type="text/javascript"></script>
	<script src="/wxpay/Public/Wap/js/date/mobiscroll_004.js" type="text/javascript"></script>
	<link href="/wxpay/Public/Wap/css/date/mobiscroll_002.css" rel="stylesheet" type="text/css">
	<link href="/wxpay/Public/Wap/css/date/mobiscroll.css" rel="stylesheet" type="text/css">
	<script src="/wxpay/Public/Wap/js/date/mobiscroll.js" type="text/javascript"></script>
	<script src="/wxpay/Public/Wap/js/date/mobiscroll_003.js" type="text/javascript"></script>
	<script src="/wxpay/Public/Wap/js/date/mobiscroll_005.js" type="text/javascript"></script>
	<link href="/wxpay/Public/Wap/css/date/mobiscroll_003.css" rel="stylesheet" type="text/css">
    <script src="/wxpay/Public/Wap/js/layer.m/layer.m.js" type="text/javascript"></script>



    <form id="form1" name="form1" action="/wxpay/wap.php?s=/Fans/auth_idcard.html" method="post">
        <div class="cont">
            <div class="list">
