...
<body>
    ...
    <div class="main-title">
        <h2><?php echo isset($info['id'])?'编辑':'新增';?>自定义菜单</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">标题<span class="check-tips">（菜单名称）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="title" value="<?php echo ((isset($info["title"]) && ($info["title"] !== ""))?($info["title"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">菜单类型<span class="check-tips">（菜单类型）</span></label>
            <div class="controls">
                <select name="menutype" class="menu_type" >
                        <option value="1">关键词回复菜单</option>
                        <option value="2">url外链菜单</option>
        ...
        <div class="form-item" id="dKeyword">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="keyword" value="<?php echo ((isset($info["keyword"]) && ($info["keyword"] !== ""))?($info["keyword"]):''); ?>">
            </div>
        </div>
        ...
        <div class="form-item" id="dSys">
            <label class="item-label">微信扩展<span class="check-tips">（微信扩展菜单）</span></label>
            <div class="controls">
                  <select name="sys">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <label class="radio"><input type="radio" name="is_show" value="1">是</label>
    ...
    <script type="text/javascript">
        ...
        Think.setValue("sys", "<?php echo ($info["sys"]); ?>");
        Think.setValue("is_show", <?php echo ((isset($info["is_show"]) && ($info["is_show"] !== ""))?($info["is_show"]): 1); ?>);
        Think.setValue("menutype", <?php echo ((isset($info["menutype"]) && ($info["menutype"] !== ""))?($info["menutype"]): 1); ?>);
        //导航高亮
