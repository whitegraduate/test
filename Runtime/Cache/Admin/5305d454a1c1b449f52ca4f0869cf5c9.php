...
<body>
    ...
    <div class="main-title">
        <h2><?php echo isset($info['id'])?'编辑':'新增';?>图文回复</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="info" value="<?php echo ((isset($info["info"]) && ($info["info"] !== ""))?($info["info"]):''); ?>">
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">图文封面</label>
            <div class="controls">
                <?php echo hook('adminPictureUpload', array('name'=>'cover_img','value'=>$info['cover_img']));?>
            </div>
        </div>
        <div class="form-item">
            <label class="item-label">图文外链地址<span class="check-tips">（如果有外链，则忽略图文详细内容）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="link_url" value="<?php echo ((isset($info["link_url"]) && ($info["link_url"] !== ""))?($info["link_url"]):''); ?>">
            </div>
        </div>
         <div class="form-item">
    ...
    <script type="text/javascript">
        Think.setValue("match_type", '<?php echo ((isset($info["match_type"]) && ($info["match_type"] !== ""))?($info["match_type"]): 1); ?>');
