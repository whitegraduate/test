    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            ...
            <div class="controls">
                <select id="shopid" name="shopid">
					...
					<?php if(is_array($lstShop)): $i = 0; $__LIST__ = $lstShop;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$shop): $mod = ($i % 2 );++$i;?><option value="<?php echo ($shop["id"]); ?>" openid="<?php echo ($shop["openid"]); ?>"><?php echo ($shop["name"]); if($shop["wechatname"] != ''): ?>-<?php echo ($shop["wechatname"]); else: ?>（未绑定微信号）<?php endif; ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        ...
        <div class="form-item">
			...
			<label class="textarea input-large">
				<textarea name="memo"><?php echo ($info["memo"]); ?></textarea>
			</label>
			</div>
		</div>
        ...
        <div class="form-item">
            ...
            <input type="hidden" name="op_user" value="<?php echo session('user_auth.username');?>">
