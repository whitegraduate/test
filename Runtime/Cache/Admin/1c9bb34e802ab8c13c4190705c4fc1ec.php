...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        ...
        <div class="form-item">
         ...
         <div class="form-item">
            <label class="item-label">回复内容<span class="check-tips">（文本回复的详细内容）</span></label>
            <div class="controls">
                <textarea name="content" class="text input-large" style="height: 150px"><?php echo ($info['content']); ?></textarea>
            </div>
        </div>
        <div class="form-item">
