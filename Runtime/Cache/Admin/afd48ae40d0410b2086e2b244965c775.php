...
<body>
    ...
    <div class="cf">
        <a class="btn" href="<?php echo U('config_add');?>">新 增 策 略</a>
        <button class="btn ajax-post confirm" url="<?php echo U('batch_give_temp');?>" target-form="ids">批量补发</button>
        ...
        <!-- 高级搜索 -->
         <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/admin.php?s=/Coupon/config.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
        ...
        <form class="ids">
            <table>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo (get_coupon_id($menu["couponid"])); ?></td>
                        <td><?php echo (get_coupon_action_type($menu["actions"])); ?></td>
                        <td><?php echo ($menu["num"]); ?></td>
                        <td><?php echo (get_yesorno($menu["status"])); ?></td>
                        <td> 
                            <a title="编辑" href="<?php echo U('config_edit?id='.$menu['id']);?>">编辑</a>
                            <a class="confirm ajax-get" title="删除" href="<?php echo U('config_del?id='.$menu['id']);?>">删除</a>
                        </td>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            //导航高亮
            highlight_subnav('<?php echo U('config');?>');
            //点击排序
