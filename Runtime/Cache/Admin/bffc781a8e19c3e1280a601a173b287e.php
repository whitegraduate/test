    ...
    <div class="cf">
        ...
        <div class="search-form fr cf">
            <div class="sleft">
                ...
                <a class="sch-btn" href="javascript:;" id="search" url="/admin.php?s=/Score/log.html"><i class="btn-search"></i></a>
            </div>
        </div>
    </div>
        ...
        <form class="ids">
            <table>
				...
				<?php if(!empty($list)): if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$menu): $mod = ($i % 2 );++$i;?><tr>
                        ...
                        <td><?php echo ($menu["fansname"]); ?></td>
                        <td><?php echo ($menu["log_type"]); ?></td>
                        <td><?php echo ($menu["score"]); ?></td>
                        <td><?php echo (date("Y-m-d H:i",$menu["createtime"])); ?></td>
                        <td><?php echo ($menu["intro"]); ?></td>
