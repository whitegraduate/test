...
<body>
    ...
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">Appid</label>
            <div class="controls">
                <input type="text" class="text input-large" name="appid" value="<?php echo ((isset($appid) && ($appid !== ""))?($appid):''); ?>">
            </div>
        </div>
        <div class="form-item" id="dKeyword">
            <label class="item-label">Appsecret<span class="check-tips"></span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="appsecret" value="<?php echo ((isset($appsecret) && ($appsecret !== ""))?($appsecret):''); ?>">
            </div>
        </div>
