...
<body>
    ...
    <div class="main-title">
        <h2><?php if($_GET['uid'] == 0): ?>新增<?php else: ?>编辑<?php endif; ?>门店账号</h2>
    </div>
    <form action="<?php echo U();?>" method="post" class="form-horizontal">
        <div class="form-item">
            <label class="item-label">用户名<span class="check-tips">（用户名会作为默认的昵称）</span></label>
            <div class="controls">
                <input type="text" class="text input-large" name="username" value="<?php echo ($info[1]); ?>">
            </div>
        </div>
        <div class="form-item">
        ...
        <div class="form-item">
            ...
            <div class="controls">
                <input type="text" class="text input-large" name="email" value="<?php echo ($info[2]); ?>">
            </div>
        </div>
        <div class="form-item">
